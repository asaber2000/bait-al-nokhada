...
const pillars = [
  {
    ...
    desc: "A dedicated engineering division with over 28 years of specialized craftsmanship adhering to German DIN safety benchmarks.",
  },
  {
    num: "02",
    title: "AFFORDABILITY & VALUE",
    desc: "Direct-from-factory pricing with high return on investment, flexible turnkey leasing, and bespoke fabrication options.",
  },
  {
    num: "03",
    title: "PROVEN RELIABILITY",
    desc: "Sustainable high-grade tensile membrane structures deployed flawlessly across 5,000+ mega-scale projects in UAE & GCC.",
  },
];
