...
export default function Preloader() {
  ...
  useEffect(() => {
    // التحقق مما إذا كانت الصفحة الحالية عربية بناءً على المسار
    const path = window.location.pathname;
    if (path.startsWith("/ar")) {
      setIsArabic(true);
    }

    // تحديد وقت ظهور الـ Preloader (1.8 ثانية)
  ...
  return (
    <AnimatePresence>
      {isLoading && (
        ...
        >
          <div className="overflow-hidden flex flex-col items-center space-y-2 text-center">
            <motion.h1
