...
const megaProjects = [
  {
    ...
    desc: "تم تنفيذ هيكل مضلع فاخر لواحدة من أكبر معرض التقنية في الشرق الأوسط، مع دمج كامل لأنظمة التكييف وهوية العلامة التجارية المخصصة.",
...
export default function FeaturedProjects() {
  return (
    <section dir="rtl" className="relative py-24 px-6 bg-[#0B1120]/70 border-t border-white/10 overflow-hidden text-right">
      
      <div className="absolute -top-32 right-1/3 w-[500px] h-[500px] bg-[#D4AF37]/5 blur-[160px] rounded-full pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {megaProjects.map((project, idx) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-linear-to-t from-[#070B14] via-[#070B14]/70 to-transparent z-10 pointer-events-none" />
              ...
              <div className="relative z-20 space-y-4">
                ...
                <div className="space-y-2">
                  <h3 className="text-2xl sm:text-3xl font-black text-white group-hover:text-[#D4AF37] transition-colors font-heading">
                    {project.title}
                  </h3>
