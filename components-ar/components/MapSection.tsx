    ...
    <section dir="rtl" className="relative py-20 px-6 bg-[#070B14] border-t border-white/10 text-right">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="relative w-full h-[400px] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
          ...
          <div className="absolute bottom-6 right-6 z-10 bg-black/80 backdrop-blur-md p-4 rounded-2xl border border-white/10 flex items-center gap-3">
            <div className="p-2.5 rounded-xl bg-[#D4AF37]/20 text-[#D4AF37]">
              <Navigation className="w-5 h-5" />
            </div>
            <div>
              <p className="text-xs font-bold text-white">مجمع أبوظبي الصناعي</p>
              <p className="text-[11px] text-slate-400">مفتوح الأحد - الخميس (8:00 صباحاً - 6:00 مساءً)</p>
            </div>
          </div>
        </div>
